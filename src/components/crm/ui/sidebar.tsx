...
import {Users, School, FileText, Calendar, Settings, Building,NotebookPen} from 'lucide-react'
    ...
    return (
        <aside className="w-64 min-h-screen bg-background border-r">
            <div className="p-4 border-b">
                <Link href='/crm'>
                <svg xmlns="http://www.w3.org/2000/svg" style={{height: 28, maxHeight: 28, width: 'auto'}}
